...
const PolicyStatDetailed = ({ cover, paymentsTotal }: Props) => {
  return (
    <div className="stats shadow stats-vertical lg:stats-horizontal w-full  ">
      <div className="stat">
        <div className="stat-title">Assigned to</div>
        <div className="stat-value text-sm text-neutral">
          {cover.vehicle.carOwner.name}
        </div>
        <div className="stat-desc">Insured Name</div>
        <div className="stat-actions">
          <Link
            href={`${BASE_URL}/client/${cover.vehicle.carOwner.slug}`}
      ...
      <div className="stat">
        ...
        <div className="stat-desc">Vehicle Market valuation</div>
      ...
      <div className="stat">
        <div className="stat-title">Premium Total</div>
        ...
        <div className="stat-actions">
          <h2 className="flex items-center gap-1 text-sm text-green-600 font-semibold">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
            ...
            Paid: {formatPrice(paymentsTotal)}
          </h2>

          {cover.premiumTotal - paymentsTotal === 0 ? null : (
            <h2 className="flex flex-row gap-1 text-sm text-error items-center font-semibold">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
...
export default PolicyStatDetailed;
